  ...
  const bookColumns = [
    {
      ...
      render: (text: string, book: Book) => (
        <Row
          ...
          align="middle" // this centers items vertically
          wrap={false}
        >
          <Col flex="100px" style={{marginRight: '0.5vw'}}>
            <img
          ...
          <Col flex="auto"  style={{ width: '200px', maxWidth: '200px' }}>
            <Text
              strong
              style={{
                whiteSpace: 'normal',
                wordBreak: 'break-word',
                overflowWrap: 'break-word', // ensures long words/wrapped content breaks
                display: 'block',
              }}
            >
              {book.title}
